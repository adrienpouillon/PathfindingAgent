...
class Geometry
{
	gce::Vector3f32 m_defaultColor = { 0, 0, 0 };
public:
	...
	const gce::Vector3f32& GetDefaultColor() const;
	const gce::Vector3f32& GetColor() const;

	void SetTexture(Texture const& texture);
	void SetColor(gce::Vector3f32 const& color);
	void SetDefaultColor(gce::Vector3f32 const& color);
