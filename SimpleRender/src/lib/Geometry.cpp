...
const gce::Vector3f32& Geometry::GetDefaultColor() const
{
	return m_defaultColor;
}

const gce::Vector3f32& Geometry::GetColor() const
{
...
void Geometry::SetDefaultColor(gce::Vector3f32 const& color)
{
	m_defaultColor = color;

	m_renderItem.objData.material.useTextureAlbedo = false;
	m_renderItem.objData.material.color = m_defaultColor;
}
